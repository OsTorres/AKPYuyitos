...
import sidebarAdmin from './SidebarConfigAdmin'
...
const MenuApp = ({ isOpenSidebar, onCloseSidebar, isOpenSidebarDesktop }) => {
	...
	const renderContent = (
		<>
			...
			<NavSection navConfig={isAdmin ? sidebarAdmin: sidebarConfig} isOpenSidebarDesktop={isOpenSidebarDesktop} />
			<Box sx={{ flexGrow: 1 }} />
		</>
	)
